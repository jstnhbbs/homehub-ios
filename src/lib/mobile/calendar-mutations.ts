...
export async function createMobileCalendarEvent(
  household: Household,
  input: z.infer<typeof calendarEventFormSchema>,
) {
...
export async function updateMobileCalendarEvent(
  household: Household,
  eventId: string,
  input: z.infer<typeof calendarEventFormSchema>,
) {
...
export async function deleteMobileCalendarEvent(
  household: Household,
  eventId: string,
) {
  const event = await db
...
export { calendarEventFormSchema };
